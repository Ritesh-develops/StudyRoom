...
const Hero = () => {
  return (
    <div className='relative h-[75vh] lg:h-[90vh] text-[#fffcf2] px-4 md:px-12 overflow-hidden '>
        {/*Background overlay */}
      <div className='bg-[#252422] h-full w-full absolute top-0 left-0 opacity-80 -z-10' > 
      ...
      <div className='w-full h-full flex flex-col justify-center items-center z-50'>
          <h1 className='text-3xl md:text-4xl lg:text-6xl pb-8 lg:pb-12 text-center max-w-5xl -mt-20'>Share your <span className='text-[#eb5e28]'>favourite</span>  books and <span className='text-[#eb5e28]'>discover</span> new ones from readers like you</h1>
